...
SELECT gid+10000000,
    ...
    CASE
        ...
        WHEN kkod IN (5012, 5017, 5021, 5024, 5028, 5032, 5033, 5812, 5817, 5821, 5824, 5828, 5833, 5834) THEN 'trunk'
        WHEN kkod IN (5022, 5822) THEN 'primary'
        WHEN kkod IN (5025, 5825) THEN 'secondary'
        WHEN kkod IN (5029, 5051, 5060, 5061, 5044, 5071, 5082, 5829, 5851, 5860, 5861, 5844, 5871, 5882) THEN 'tertiary'
        WHEN kkod IN (5056, 5058, 5044, 5840, 5844, 5858, 5856) THEN 'residential'
        WHEN kkod IN (5091, 5891) THEN 'service'
        ELSE 'other' END AS type,
    CASE
        ...
        WHEN kkod IN (5029, 5051, 5058, 5060, 5061, 5056, 5044, 5091, 5044, 5071, 5082, 5829, 5851, 5856, 5858, 5860, 5861, 5840, 5844, 5891, 5844, 5871, 5882) THEN 'minorroad'
        ELSE 'other' END AS stylegroup,
    CASE
        WHEN kkod IN (5011, 5016, 5034, 5811, 5816, 5834) THEN 7
        WHEN kkod IN (5012, 5017, 5021, 5024, 5028, 5032, 5033, 5812, 5817, 5821, 5824, 5828, 5833, 5834) THEN 6
        WHEN kkod IN (5022, 5822) THEN 5
        WHEN kkod IN (5025, 5825) THEN 4
        WHEN kkod IN (5029, 5051, 5060, 5061, 5071, 5082, 5829, 5851, 5860, 5861, 5871, 5882) THEN 3
        WHEN kkod IN (5056, 5058, 5044, 5840, 5844, 5856, 5858) THEN 2
        WHEN kkod IN (5091, 5891) THEN 1
        ELSE 0 END AS zindex,
    0 as bridge, 0 as tunnel,
    CASE
  ...
  WHERE kkod IN (5011, 5012, 5016, 5017, 5060, 5021, 5022, 5051, 5061, 5024, 5025,
    5028, 5029, 5032, 5033, 5034, 5056, 5058, 5044, 5071, 5082, 5091,
    5811, 5812, 5816, 5817, 5860, 5821, 5822, 5861, 5824, 5825,
    5828, 5829, 5833, 5834, 5834, 5840, 5844, 5851, 5856, 5858, 5871, 5882, 5891);
